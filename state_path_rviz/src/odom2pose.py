...
def odom_callback(msg):
    ...
    marker.color.b = blue
    marker.lifetime = rospy.Duration(5)# 图像停留时间为5s 填0则为永久
    if last_position is not None:
        ...
        line.color.b = blue
        line.color.a = 1.0
        line.lifetime = rospy.Duration(5)# 图像停留时间为5s 填0则为永久
...
if __name__ == '__main__':
    ...
    line_pub = rospy.Publisher(line_topic, Marker, queue_size=10)
